	...
	<body>
	    <%@ include file="/subviews/header.jsp" %>
	    	<div id="main">
		        ...
		        <div class="product" id="product">
		        	<div class="product_scroll" id="product_scroll">
		        		<div class="product_all" id="product_all">
		        			<img src="https://cdn.cybassets.com/media/W1siZiIsIjEyOTM1L3Byb2R1Y3RzLzM0MDMwMjg1LzE2MjYyNDYzMDhfNzE0OTcwNWY5M2I1YjJhZmY3NjYuanBlZyJdLFsicCIsInRodW1iIiwiNjAweDYwMCJdXQ.jpeg?sha=c4a6e9a825e02317">
						</div>
						<div id="info"></div>
		        ...
		        <aside>
		        	<h1><b>Coleman 吸震摺椅</b></h1>
		        	<h4 style="color:#808080;"><b>
		        		居家、露營登山、戶外活動皆適用的輕量摺椅<br>
						緩衝墊設計，有舒壓效果<br>
						輕巧易攜，附原廠收納袋<br>
						最大承載重量：約70kg</b></h4>
					<strong class="sell_price"><b>建議售價</b></strong>
					<h1 style="color: #b8860b;"><b>NT$650</b></h1>
					<label><b>顏色:</b></label>
						<input type="radio" name="color" value="綠" title="5" data-stock="5" onclick="changeData(this)" required><label><b>綠色</b></label>
						<input type="radio" name="color" value="灰" title="3" data-stock="3" onclick="changeData(this)" required><label><b>灰色</b></label>
						<input type="radio" name="color" value="紅" title="4" data-stock="4" onclick="changeData(this)" required><label><b>紅色</b></label>
						<input type="radio" name="color" value="深藍" title="2" data-stock="2" onclick="changeData(this)" required><label><b>深藍色</b></label>
					<br>
					<br>
					...
					<div class="btn_group">
						...
						<input id="quantity" type="number" class="number" value="1" min="1" max="20">
						<button class="btn1">
